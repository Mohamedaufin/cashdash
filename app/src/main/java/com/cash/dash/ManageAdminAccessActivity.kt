...
class ManageAdminAccessActivity : ThemedActivity() {
    ...
    private fun showEditAdminPermissionsDialog(
        ...
        // Same shared tint as the permission check boxes above. This one also keyed only
        // on state_enabled, so checked and unchecked both came out white on the dark
        // themes and the box read as filled rather than as an outline.
        cbIncludeNotification?.buttonTintList = ThemeHelper.compoundButtonTint(this)
