...
class EntryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSelectLogin.setOnClickListener {
            isLoginFlow = true
            showAuthForm(true, layoutSelection, layoutAuthForm, edtName, edtPhone, btnAction, tvForgotPassword)
        }

        btnSelectRegister.setOnClickListener {
            isLoginFlow = false
            showAuthForm(false, layoutSelection, layoutAuthForm, edtName, edtPhone, btnAction, tvForgotPassword)
        }
    ...
    private fun showAuthForm(isLogin: Boolean, selection: View, form: View, edtName: View, edtPhone: View, btnAction: Button, tvForgot: View) {
    ...
    private fun showAdminDeletionDialog() {
        ...
        runOnUiThread {
            try {
                ...
                tvMessage?.text = "Admin has deleted your account due to privacy concerns. Please register a new account."
